...
*   **滑鼠直覺控制**：擋板會跟隨滑鼠游標移動，提供流暢且直覺的操控手感。
...
*   **移動擋板**：在遊戲視窗內左右移動 **滑鼠**。
*   **點擊按鈕**：使用 **滑鼠左鍵** 點擊介面上的按鈕進行遊戲開始、重新啟動或離開遊戲。

## 開發者與致謝

*   **Developer**: HiTea
*   **Contact Email**: gepi45458@gmail.com
*   **AI 協作**: 本專案使用 Machinet AI 輔助開發，並由 ChatGPT 協助進行程式碼除錯與優化。

## License / 版權聲明

Copyright © 2023 HiTea. All rights reserved.
